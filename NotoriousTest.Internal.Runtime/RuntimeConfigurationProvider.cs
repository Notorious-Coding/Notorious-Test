...
{
    public class RuntimeConfigurationProvider : IRuntime
    {
        private const string RuntimeFile = "runtimeconfig.json";
        private readonly ITestLogger _logger;
        private RuntimeConfiguration? _cache = null;

        private readonly JsonSerializerOptions JSON_OPTIONS = new JsonSerializerOptions { PropertyNameCaseInsensitive = true };
