...
namespace NotoriousTest.SqlServer
{
    ...
    {
        public SqlServerContainerInfrastructure(EnvironmentId contextId, ITestLogger logger, IRegistry registry, EnvironmentSettings settings) : base(contextId, logger, registry, settings)
        {
        }
