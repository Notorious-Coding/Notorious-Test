...
namespace NotoriousTest.IntegrationTests.DoggyDog
{
    public class DoggyDogTests : IntegrationTest<DoggyDogEnvironment>
    {
        ...
        public async Task DoggyDog_Should_Do_Nothing_When_Process_Exit_Normally()
        {
            ...
            Process? doggyDogProcess = DoggyDogTestFramework.Act.StartDoggyDog(process.Id, typeof(DoggyDogTests).Assembly.Location, registry.GetDatabaseConnectionString(), environmentId);
        ...
        public async Task DoggyDog_Should_Exit_When_Monitored_Process_Not_Found()
        {
            ...
            Process? doggyDogProcess = DoggyDogTestFramework.Act.StartDoggyDog(PROCESS_ID, typeof(DoggyDogTests).Assembly.Location, registry.GetDatabaseConnectionString(), environmentId);
        ...
        public async Task DoggyDog_Should_Exit_When_Registry_File_Not_Found()
        {
            ...
            Process? doggyDogProcess = DoggyDogTestFramework.Act.StartDoggyDog(process.Id, typeof(DoggyDogTests).Assembly.Location, FAKE_CONNECTION_STRING, environmentId);
        ...
        public async Task DoggyDog_Should_Cleanup_Multiple_Orphan_Infrastructures_When_Process_Crashes()
        {
            ...
            var fakeEntry1 = await DoggyDogTestFramework.Arrange.PopulateRegistryWithFakeInfrastructure(registry, process, typeof(DoggyDogTestFramework.Arrange.FakeInfrastructureWithCleaner), environmentId);
            var fakeEntry2 = await DoggyDogTestFramework.Arrange.PopulateRegistryWithFakeInfrastructure(registry, process, typeof(DoggyDogTestFramework.Arrange.FakeInfrastructure2WithCleaner), environmentId);
